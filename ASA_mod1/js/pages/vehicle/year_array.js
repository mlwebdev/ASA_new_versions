var selectWrap = selectWrap = f.getId("select-wrap");

function yearSelect(yearArray, makeOption){
  yearArray = [ 
    "--Select Year--", "2019", "2018", "2017","2016","2015", "2014",
  ...
  yearSel = f.create("select");
  selectWrap.appendChild(yearSel);
  makeOption = f.create("option");
  makeOption.innerHTML = "Test good";
  yearSel.appendChild(makeOption);
}
//selectWrap.innerHTML = yearSelect();
...
//   console.log(year)
// }
// f.append(vehicleForm, selectDiv);

// yearSelect.id = "yearSelect";
// yearSelect.className = "space";
// f.append(selectDiv, yearSelect);